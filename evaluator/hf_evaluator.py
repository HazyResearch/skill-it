...
class HFEvaluator(AbstractEvaluator):
    ...
    def evaluate(self, tokenized_data, counter, weights, output_idxs=None):
    ...
    def _make_dataloader(self, tokenized_data):
        string_columns = ["text", "slice", "created_timestamp", "downloaded_timestamp", "url"]
